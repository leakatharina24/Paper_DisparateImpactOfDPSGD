...
from .neural_networks import (CNN, MLP, LogisticRegression, TabularClassifier)
...
def create_model(config, device):
    ...
    elif config["net"] == "deoliveira":
        model = TabularClassifier(
            in_dim=config["data_shape"][0],
            n_hidden_blocks=config["num_blocks"],
